...
#    e.g. make -f demo_rdbms.mk build EXE=cdemo81 OBJS=cdemo81.o
#
# 3. A single OCI demo with static libraries:
#
#    make -f demo_rdbms.mk build_static EXE=demo OBJS="demo.o ..."
#    e.g. make -f demo_rdbms.mk build_static EXE=cdemo81 OBJS=cdemo81.o
#
...
#    e.g. make -f demo_rdbms.mk build_nopthread EXE=cdemo81 OBJS=cdemo81.o
#
#
...
DEMOS = cdemo81 cdemo82 \
        cdemobj cdemolb cdemodsc cdemocor cdemolb2 cdemolbs \
        cdemodr1 cdemodr2 cdemodr3 cdemodsa \
        cdemoext cdemothr cdemofil cdemofor cdemosyev \
	ociaqdemo00 ociaqdemo01 ociaqdemo02 cdemoucb nchdemo1 \
        ociaqarraydeq ociaqarrayenq strmmon cdemoclid
